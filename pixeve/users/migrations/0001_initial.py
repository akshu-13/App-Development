    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.CharField(choices=[('wedding', 'Wedding'), ('birthday', 'Birthday'), ('surprise', 'Surprise'), ('special', 'Special'), ('others', 'Others')], default='others', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='users.event')),
            ],
        ),
        migrations.CreateModel(
            name='Photo',
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='users.event')),
            ],
        ),
    ]
